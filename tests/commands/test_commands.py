...
def test_run_recover(b, alice, bob):
    ...
    tx1 = Create.generate(
        [alice.public_key], [([alice.public_key], 1)], asset="QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4", metadata="QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4"
    ).sign([alice.private_key])
    tx2 = Create.generate(
        [bob.public_key], [([bob.public_key], 1)], asset="QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4", metadata="QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4"
