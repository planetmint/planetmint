...
def test_single_in_single_own_single_out_single_own_create(alice, user_pk, b):
    ...
    tx = Create.generate([alice.public_key], [([user_pk], 100)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" })
...
def test_single_in_single_own_multiple_out_single_own_create(alice, user_pk, b):
    ...
    tx = Create.generate([alice.public_key], [([user_pk], 50), ([user_pk], 50)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" })
    tx_signed = tx.sign([alice.private_key])
...
def test_single_in_single_own_single_out_multiple_own_create(alice, user_pk, b):
    ...
    tx = Create.generate([alice.public_key], [([user_pk, user_pk], 100)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" })
    tx_signed = tx.sign([alice.private_key])
...
def test_single_in_single_own_multiple_out_mix_own_create(alice, user_pk, b):
    ...
    tx = Create.generate(
        [alice.public_key], [([user_pk], 50), ([user_pk, user_pk], 50)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_signed = tx.sign([alice.private_key])
...
def test_single_in_single_own_single_out_single_own_transfer(alice, b, user_pk, user_sk):
    ...
    # CREATE divisible asset
    tx_create = Create.generate([alice.public_key], [([user_pk], 100)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4"} )
...
def test_single_in_multiple_own_single_out_single_own_transfer(alice, b, user_pk, user_sk):
    ...
    tx_create = Create.generate(
        [alice.public_key], [([alice.public_key, user_pk], 100)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_multiple_in_single_own_single_out_single_own_transfer(alice, b, user_pk, user_sk):
    # CREATE divisible asset
    tx_create = Create.generate(
        [alice.public_key], [([user_pk], 50), ([user_pk], 50)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_muiltiple_in_mix_own_multiple_out_single_own_transfer(alice, b, user_pk, user_sk):
    ...
    # CREATE divisible asset
    tx_create = Create.generate(
        [alice.public_key], [([user_pk], 50), ([user_pk, alice.public_key], 50)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_multiple_in_different_transactions(alice, b, user_pk, user_sk):
    ...
    tx_create = Create.generate(
        [alice.public_key], [([user_pk], 50), ([alice.public_key], 50)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_threshold_same_public_key(alice, b, user_pk, user_sk):
    ...
    # CREATE divisible asset
    tx_create = Create.generate([alice.public_key], [([user_pk, user_pk], 100)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" })
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_sum_amount(alice, b, user_pk, user_sk):
    ...
    tx_create = Create.generate(
        [alice.public_key], [([user_pk], 1), ([user_pk], 1), ([user_pk], 1)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" }
    )
    tx_create_signed = tx_create.sign([alice.private_key])
...
def test_divide(alice, b, user_pk, user_sk):
    ...
    tx_create = Create.generate([alice.public_key], [([user_pk], 3)], asset= { "data": "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4" })
    tx_create_signed = tx_create.sign([alice.private_key])
