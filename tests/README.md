...
Most of the tests in the `tests/` folder are unit tests. For info about how to write and run tests, see [the docs about contributing to Planetmint](http://docs.bigchaindb.com/projects/contributing/en/latest/index.html), especially:
